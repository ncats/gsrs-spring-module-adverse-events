...
@EnableJpaRepositories(
        entityManagerFactoryRef = AdverseEventDataSourceConfig.NAME_ENTITY_MANAGER,
        transactionManagerRef = AdverseEventDataSourceConfig.NAME_TRANSACTION_MANAGER,
        basePackages = {"gov.hhs.gsrs.adverseevents"}
)
@Slf4j
public class AdverseEventDataSourceConfig extends GSRSDataSourceConfig {
    ...
    protected static final String[] BASE_PACKAGES = new String[] {"gov.hhs.gsrs.adverseevents"};
    protected static final String PERSIST_UNIT = "adverseevent";
  //  protected static final String DATASOURCE_PROPERTY_PATH_PREFIX = "spring";
   ...
   // @Primary
    public LocalContainerEntityManagerFactoryBean getAdverseEventEntityManager(EntityManagerFactoryBuilder builder,
